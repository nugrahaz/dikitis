...
//
// void main() async {
//   var delegate = await LocalizationDelegate.create(fallbackLocale: 'en_US', supportedLocales: ['en_US', 'es', 'fa', 'ar', 'ru']);
//
...
//                 args: {'language': translate('language.name.${localizationDelegate.currentLocale.languageCode}')})),
//             Padding(
...
//                 )),
//             Padding(padding: const EdgeInsets.only(bottom: 10), child: Text(translatePlural('plural.demo', _counter))),
//             Row(
//               mainAxisAlignment: MainAxisAlignment.center,
//               children: <Widget>[
//                 IconButton(
...
//     showCupertinoModalPopup<String>(context: context, builder: (BuildContext context) => child).then((String? value) {
